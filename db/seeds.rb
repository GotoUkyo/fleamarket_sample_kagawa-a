...
# Item.create!(name: 'お宝', description: '見ちゃだめ', brand: '', state_id: 1, postage_id: 1, prefecture_id: 1, day_id: 1, price: 5000, deal_state_id: 0, user_id: 2, category_id: 1)
# Item.create!(name: '鉛筆', description: 'イタリアで買ったものです', brand: '', state_id: 1, postage_id: 1, prefecture_id: 1, day_id: 1, price: 2000, deal_state_id: 0, user_id: 2, category_id: 1)